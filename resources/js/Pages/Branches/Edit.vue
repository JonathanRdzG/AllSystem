...
const save = () => form.put(`/branches/${props.record.id}`);
</script>
<template>
  <AdminLayout :page-title="isEdit ? 'Editar sucursal' : 'Nueva sucursal'">
    <ResourceForm
      :title="isEdit ? 'Editar sucursal' : 'Registrar sucursal'"
      description="Actualiza la información operativa y de contacto de esta sucursal."
      :form="form"
      :fields="fields"
      submit-label="Actualizar sucursal"
