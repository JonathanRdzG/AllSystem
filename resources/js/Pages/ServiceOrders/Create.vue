...
const save = () => form.post('/service-orders');
</script>
<template>
  <AdminLayout :page-title="isEdit ? 'Editar orden de servicio' : 'Nueva orden de servicio'">
    <ResourceForm
      ...
      description="Organiza la ejecución del servicio con cliente, responsable, estado y fecha compromiso."
      :form="form"
      :fields="fields"
      submit-label="Guardar orden"
